...
class Base extends Controller {
    ...
    */
    ...
    public function exportExcel_2(){  
        ...
        $objPayable = $objRichText->createTextRun('2017年度教学工作量表');  //大标题
        $objPayable->getFont()->setBold(true);
        $objPayable->getFont()->setItalic(true);
        ...
        //设置第二行名称
        $objPHPExcel->getActiveSheet()->setCellValue('B2', '网络教研室');
        $objPHPExcel->getActiveSheet()->setCellValue('E2', '姓名：');
        $objPHPExcel->getActiveSheet()->setCellValue('F2', '袁宗福');
        $objPHPExcel->getActiveSheet()->setCellValue('H2', '职称：');
        $objPHPExcel->getActiveSheet()->setCellValue('J2', '副教授');
        $objPHPExcel->getActiveSheet()->setCellValue('N2', '减免工作量：');
        $objPHPExcel->getActiveSheet()->setCellValue('R2', '%');
        $objPHPExcel->getActiveSheet()->setCellValue('S2', '工号');
        $objPHPExcel->getActiveSheet()->setCellValue('A3', '袁宗福');
        $objPHPExcel->getActiveSheet()->setCellValue('A4', '学期');
        $objPHPExcel->getActiveSheet()->setCellValue('B4', '课程名称');
        $objPHPExcel->getActiveSheet()->setCellValue('F4', '班级');
        $objPHPExcel->getActiveSheet()->setCellValue('J4', '学生人数');
        $objPHPExcel->getActiveSheet()->setCellValue('K4', '周数');
        $objPHPExcel->getActiveSheet()->setCellValue('L4', '周学时');
        $objPHPExcel->getActiveSheet()->setCellValue('M4', '理论教学总时效');
        $objPHPExcel->getActiveSheet()->setCellValue('N4', '合班系数');
        $objPHPExcel->getActiveSheet()->setCellValue('O4', '重复班系数');
        $objPHPExcel->getActiveSheet()->setCellValue('P4', '开新课新开课系数');
        $objPHPExcel->getActiveSheet()->setCellValue('Q4', '多作业系数');
        $objPHPExcel->getActiveSheet()->setCellValue('R4', '计算公式');
        $objPHPExcel->getActiveSheet()->setCellValue('S4', '工作量');
        $objPHPExcel->getActiveSheet()->setCellValue('U4', '复核输');
        $objPHPExcel->getActiveSheet()->setCellValue('W4', '备注');
        // 设置宽度
