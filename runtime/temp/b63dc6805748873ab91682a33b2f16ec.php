            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>增员活动信息 <small>包括定位和活动信息</small></h5>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post" action="<?php echo U('pacificocean/new_add_handle'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="活动标题" name="title" class="form-control" required="" aria-required="true" value="<?php echo $info['title']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="活动人数" name="number" class="form-control" required="" aria-required="true" value="<?php echo $info['number']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">活动日期范围：</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <a href="<?php echo $info['code_address']; ?>" target="_blank">
                                        <img src='<?php echo $info['code_address']; ?>' style="width: 150px;height: 150px;">
                                    </a>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
