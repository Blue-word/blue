<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"./application/index/view/pacificocean\apply_list.html";i:1521992198;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="row row-lg">
                    <div class="col-sm-12">
                        ...
                        <div class="example-wrap">
                            <h4 class="example-title"><?php echo $course_name; ?> —— 新人报名表</h4>
                            <div class="example">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <div class="col-sm-3">
                                        <form id="form-import" method="post" action="<?php echo U('report/course_apply_list_import'); ?>" enctype="multipart/form-data">
                                           <input type="file" name="file">
                                           <input type="hidden" name="id" value="<?php echo $id; ?>">
                                           <button type="submit" id="file_upload" class="btn btn-outline btn-default">
                                                <i class="glyphicon glyphicon-plus" aria-hidden="true">导入新人报名</i>
                                            </button>
                                        </form>
                                    </div>
                                    <div class="col-sm-5">
                                       <a href="<?php echo U('pacificocean/course_list'); ?>" style="padding-left: 50px;">
                                            <button type="button" class="btn btn-outline btn-default"><i class="fa fa-reply-all" >返回课程</i></button>
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                                            <tr>
                                                <td align="center" class="">
                                                    ...
                                                    <div><?php echo $vo['current_id']; ?></div>
                                                </td>
                                                <td align="center" class="">
                                                ...
                                                <td align="center" class="">
                                                    <a href="<?php echo U('pacificocean/new_info',array('id'=>$vo['id'])); ?>"><button class="btn btn-info btn-sm demo4" >查看资料</button>
                                                    </a>
                                                    </a>
    ...
    <script>
        $(function() {
            ...
            $('#file_upload').on('click', function() {
                $.ajax({
                    url: '/blue/index.php/index/report/course_apply_list_import',
                    type: "post",
