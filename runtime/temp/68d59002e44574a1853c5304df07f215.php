<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"./application/index/view/pacificocean\position_set.html";i:1519464323;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>定位签到范围设置 <small>包括定位半径和定位经纬度</small></h5>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('pacificocean/signinfo_handle'); ?>" class="form-horizontal m-t" id="signupForm">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">定位经纬度</label>
                                <div class="col-sm-10">
                                    <input type="text" placeholder="例如：116.403963,39.915119" name="coordinate" class="form-control">
                                    格式：经度,纬度
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="radius" max="9999" type="number" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">定位日期范围：</label>
                                <div class="col-sm-10">
                                    <input placeholder="开始日期" class="form-control layer-date" id="start" name="start_time" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                    <input placeholder="结束日期" class="form-control layer-date" id="end" name="end_time" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <!-- <div class="form-group">
