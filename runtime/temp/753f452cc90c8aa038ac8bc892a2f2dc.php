<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"./application/index/view/pacificocean\course_info1.html";i:1520319941;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <!-- 百度地图 -->
    <style type="text/css">
    #container {width: 1230px;height: 380px;overflow: hidden;margin:0;font-family:"微软雅黑";}
    </style>
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=uzZhQDkARtTIbiTOydzupoQE7wQ4WkNn"></script>
    <!-- 图片上传 -->
    <link rel="stylesheet" type="text/css" href="/blue/public/static/plugins/fileinput/css/fileinput.min.css" />
    <!-- <link rel="stylesheet" type="text/css" href="/blue/public/static/css/bootstrap.css" /> -->
    <link rel="stylesheet" type="text/css" href="/blue/public/static/css/bootstrap1.css" />
...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>新人培训课程编辑&nbsp;&nbsp;&nbsp;<small>包括定位和课程信息</small></h5>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('pacificocean/course_handle'); ?>" class="form-horizontal m-t" id="signupForm">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">定位经纬度</label>
                                <div class="col-sm-10">
                                    <input type="text" placeholder="例如：116.403963,39.915119" name="coordinate" class="form-control" required="" aria-required="true" value="<?php echo $info['coordinate']; ?>">
                                    格式：经度，纬度
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input name="radius" max="9999" type="number" class="form-control" required="" aria-required="true" value="<?php echo $info['radius']; ?>">
                                    单位：米（M）
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="请输入标题" name="title" class="form-control" required="" aria-required="true" value="<?php echo $info['title']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <!-- <div class="formControls col-xs-8 col-sm-7"> -->
                                        <input id="album" class="file" type="file" name="image[]" multiple>
                                    <!-- </div> -->
                                    <!-- <input type="text" placeholder="请输入角色名称" name="picture" class="form-control" required="" aria-required="true" value="<?php echo $info['picture']; ?>"> -->
                                </div>
                            </div>
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">课程日期范围：</label>
                                <div class="col-sm-10">
                                    <input placeholder="开始日期" class="form-control layer-date" id="start" name="start_time" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" value="<?php echo $info['start_time']; ?>">
    ...
    <!-- 全局js -->
    <script src="/blue/public/static/js/jquery-2.1.4.js"></script>
    ...
    <script src="/blue/public/static/plugins/fileinput/js/plugins/canvas-to-blob.min.js"></script>
    <script src="/blue/public/static/plugins/fileinput/js/fileinput.min.js"></script>
    <script src="/blue/public/static/plugins/fileinput/js/fileinput_locale_zh.js"></script>
    ...
    <script>
        ...
        $("#album").fileinput({
            ...
            uploadUrl:"/blue/index.php/index/Uploadify/imgUp/rootpath/notice/savepath/picture/type/2",//上传地址
            allowedFileExtensions : ['jpg', 'png','gif','jpeg'],//允许的文件后缀
            maxFilesNum: 10,//最大文件上传数量
            deleteUrl:'/blue/index.php/index/Uploadify/delupload',//删除地址
            ...
            initialPreview: [       //初始化展示
                <?php if(is_array($pic_list) || $pic_list instanceof \think\Collection || $pic_list instanceof \think\Paginator): if( count($pic_list)==0 ) : echo "" ;else: foreach($pic_list as $key=>$picInfo): ?>
                "<?php echo $picInfo; ?>",
                <?php endforeach; endif; else: echo "" ;endif; ?>
            ],
            ...
            { 
                width: '213.33px', 
                // url: '/blue/index.php/index/Uploadify/delupload', // server delete action 
                //showUpload:false, 
                //extra: {filename: "<?php echo $picInfo; ?>"},
                //previewAsData:false,
                key:"<?php echo $picInfo; ?>",
            },
            <?php endforeach; endif; else: echo "" ;endif; ?>
            ],
