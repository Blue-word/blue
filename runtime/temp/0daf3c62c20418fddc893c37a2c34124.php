<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:40:"./application/index/view/test\test1.html";i:1521184985;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form method="post" action="<?php echo U('test/export'); ?>" enctype="multipart/form-data">
