<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./application/index/view/test\asdzxcd.html";i:1521863514;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form method="post" action="<?php echo U('test/asdzxcd'); ?>">
   name<input type="text" name="name" value="">
   sort<input type="text" name="sort" value="">
   pid<input type="text" name="pid" value="">
   <button type="submit" class="btn btn-success glyphicon glyphicon-plus">添加</button>
</form>
</div>
