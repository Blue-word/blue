<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/index/view/admin\admin_password.html";i:1522317911;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" action="<?php echo U('admin/admin_password'); ?>" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">原密码：</label>
                                <div class="col-sm-8">
                                    <input name="original_pas" class="form-control" type="password" required="" aria-required="true">
                                </div>
                            </div>
