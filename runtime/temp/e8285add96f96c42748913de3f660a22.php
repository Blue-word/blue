<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./application/index/view/goods\goods_info.html";i:1544341962;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('goods/goods_handle'); ?>" class="form-horizontal m-t" id="signupForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="album" class="file" type="file" name="image[]" aria-required="false">
                                </div>
                            </div>
                            <!-- <div class="hr-line-dashed"></div>
                            <div class="form-group">
