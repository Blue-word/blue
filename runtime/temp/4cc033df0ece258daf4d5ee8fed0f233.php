<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/index/view/index\index_v3.html";i:1516198712;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <!-- Morris -->
    <link href="/blue/public/static/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="/blue/public/static/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <!-- Flot -->
    <script src="/blue/public/static/js/plugins/flot/jquery.flot.js"></script>
    <script src="/blue/public/static/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/blue/public/static/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/blue/public/static/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/blue/public/static/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/blue/public/static/js/plugins/flot/jquery.flot.symbol.js"></script>
    ...
    <!-- Jvectormap -->
    <script src="/blue/public/static/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/blue/public/static/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="/blue/public/static/js/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="/blue/public/static/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/blue/public/static/js/demo/sparkline-demo.js"></script>
