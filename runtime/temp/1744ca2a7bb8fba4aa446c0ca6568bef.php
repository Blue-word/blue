            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>增员活动编辑&nbsp;&nbsp;&nbsp;<small>包括定位和活动信息</small></h5>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('pacificocean/new_add_handle'); ?>" class="form-horizontal m-t" id="signupForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="请输入活动地点" name="place" class="form-control" required="" aria-required="true" value="<?php echo $info['place']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
