<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"./application/index/view/pacificocean\course_view.html";i:1520515005;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>新人培训课程查看 <small>包括定位和课程信息</small></h5>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post" action="<?php echo U('pacificocean/course_handle'); ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">定位经纬度</label>
                                <div class="col-sm-10">
                                    <input type="text" placeholder="例如：116.403963,39.915119" name="coordinate" class="form-control" value="<?php echo $info['coordinate']; ?>">
                                    格式：经度，纬度
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="课程标题" name="title" class="form-control" required="" aria-required="true" value="<?php echo $info['title']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="轮播图图片" name="picture" class="form-control" required="" aria-required="true" value="<?php echo $info['picture']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="地点" name="place" class="form-control" required="" aria-required="true" value="<?php echo $info['place']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="讲师" name="lecturer" class="form-control" required="" aria-required="true" value="<?php echo $info['lecturer']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" placeholder="已报名人数" name="apply_number" class="form-control" required="" aria-required="true" value="<?php echo $info['apply_number']; ?>">
                                </div>
                                <div class="col-sm-1">
                                    <a href="<?php echo U('pacificocean/apply_list'); ?>">
                                        <button class="btn btn-info">查看名单</button>
                                    </a>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="发布时间" name="time" class="form-control" required="" aria-required="true" value="<?php echo $info['time']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="发布者" name="admin_name" class="form-control" required="" aria-required="true" value="<?php echo $info['admin_name']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="审核员" name="audit_name" class="form-control" value="<?php echo $info['audit_name']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <?php if($info['status'] == 0): ?>
                                        <button class="btn btn-primary" type="submit" name="status" value="1">审核通过</button>
                                        <button class="btn btn-danger" type="submit" name="status" value="-1">驳回审核</button>
