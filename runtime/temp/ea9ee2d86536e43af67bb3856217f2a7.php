<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"./application/index/view/pacificocean\course_info.html";i:1522308120;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('pacificocean/course_handle'); ?>" class="form-horizontal m-t" id="signupForm">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="例如：116.403963,39.915119" name="coordinate" id="coordinate" class="form-control" required="" aria-required="true" value="<?php echo $info['coordinate']; ?>">
                                    格式：经度，纬度
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control m-b" name="course_cate" required="" aria-required="true">
                                        <option value="">请选择类别</option>
                                        <option value="保代班">保代班</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="album" class="file" type="file" name="image[]" multiple required="" aria-required="true">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
