<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./application/index/view/goods\goods_list.html";i:1544336592;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <a href="<?php echo U('goods/goods_info'); ?>">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                                            <tr>
                                                ...
                                                <td align="center" class="">
                                                    <div>　
                                                        <a href="<?php echo U('goods/apply_list',array('id'=>$vo['id'])); ?>" style="color: #676a6c">
                                                            <button type="button" class="btn btn-outline btn-default" href="<?php echo U('goods/apply_list'); ?>"><?php echo $vo['apply_number']; ?> / 查看名单</button>
                                                        </a>
                                                    </div>
                                                </td> -->
                                                <td align="center" class="">
                                                ...
                                                <td align="center" class="change_td">
                                                    ...
                                                    <?php elseif($vo['status'] == 1): ?>
                                                        <span class="label label-primary label2">已审核</span>
                                                    <?php elseif($vo['status'] == 2): ?>
                                                        <span class="label label-default label3">已拒绝</span>
                                                    <?php elseif($vo['status'] == -1): ?>
                                                ...
                                                <td align="center" class="">
                                                    ...
                                                    <?php endif; ?> 
                                                    <a href="<?php echo U('goods/goods_view',array('id'=>$vo['id'])); ?>"><button class="btn btn-info btn-sm" >查看</button>
                                                    </a>
                                                    <a href="<?php echo U('goods/goods_info',array('id'=>$vo['id'])); ?>"><button class="btn btn-primary btn-sm" >编辑</button>
                                                    </a>
