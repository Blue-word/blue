<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"./application/index/view/pacificocean\weixin_info.html";i:1520213571;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>查看微信资料 <small>包括昵称和地址</small></h5>
                        <div class="ibox-tools">
                            <a href="javascript:history.go(-1)" placeholder="返回管理员列表">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('admin/admin_handle'); ?>" class="form-horizontal m-t" id="signupForm">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled="" placeholder="请输入用户名" name="nickname" class="form-control" value="<?php echo $info['nickname']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled="" placeholder="请输入用户名" name="sex" class="form-control" value="<?php echo $info['sex']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled="" placeholder="请输入用户名" name="province" class="form-control" value="<?php echo $info['province']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled="" placeholder="请输入用户名" name="city" class="form-control" value="<?php echo $info['city']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled="" placeholder="请输入用户名" name="country" class="form-control" value="<?php echo $info['country']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="text-center">
                                        <img alt="image" class="img-circle m-t-xs img-responsive" src="<?php echo $info['headimgurl']; ?>">
                                        <div class="m-t-xs font-bold">CTO</div>
                                    </div>
                                </div>
                                <div class="col-sm-10">
                                    <img src="">
                                    <input type="text" disabled="" placeholder="请输入邮箱地址" name="headimgurl" class="form-control" type="text" required="" aria-required="true" value="<?php echo $info['headimgurl']; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                        </form>
                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html#" class="pull-left">
                                        <img alt="image" class="img-circle" src="/blue/public/static/img/a1.jpg">
                                    </a>
                                ...
                                <div class="feed-element">
                                    <a href="profile.html#" class="pull-left">
                                        <img alt="image" class="img-circle" src="/blue/public/static/img/profile.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html#" class="pull-left">
                                        <img alt="image" class="img-circle" src="/blue/public/static/img/a2.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html#" class="pull-left">
                                        <img alt="image" class="img-circle" src="/blue/public/static/img/a3.jpg">
                                    </a>
                                    <div class="media-body ">
                                        ...
                                        <div class="photos">
                                            <a target="_blank" href="http://24.media.tumblr.com/20a9c501846f50c1271210639987000f/tumblr_n4vje69pJm1st5lhmo1_1280.jpg">
                                                <img alt="image" class="feed-photo" src="/blue/public/static/img/p1.jpg">
                                            </a>
                                            <a target="_blank" href="http://37.media.tumblr.com/9afe602b3e624aff6681b0b51f5a062b/tumblr_n4ef69szs71st5lhmo1_1280.jpg">
                                                <img alt="image" class="feed-photo" src="/blue/public/static/img/p3.jpg">
                                            </a>
                                        </div>
                                    </div>
                                </div>
