<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/index/view/goods\category_list.html";i:1543846184;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="row row-lg">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-8 example-wrap">
                            <h4 class="example-title">商品类型列表&nbsp;&nbsp;&nbsp;<small>提示：删除商品会导致已选择该商品的新人的商品数据置为1（即下表商品ID为1的状态）</small></h4>
                            <div class="example">
        ...
        <div class="modal inmodal" id="myModal2" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated flipInY">
                    ...
                    <form method="post" action="<?php echo U('Goods/category_handle'); ?>" class="form-horizontal m-t" id="signupForm">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <input type="text" placeholder="请商品分类名称" id="category_name" name="name" class="form-control" type="text" required="" aria-required="true" value="<?php echo $info['name']; ?>">
                                <input type="hidden" id="category_id" name="id" value="<?php echo $info['id']; ?>">
                            </div>
                        </div>
                    </div>
